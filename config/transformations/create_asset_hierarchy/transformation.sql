  ...
  /* {"version":1,"sourceType":"raw","mappings":[{"from":"","to":"externalId"},{"from":"","to":"parentExternalId"},{"from":"","to":"source"},{"from":"","to":"name"},{"from":"","to":"description"},{"from":"","to":"metadata"},{"from":"","to":"dataSetId"},{"from":"","to":"labels"}],"sourceLevel1":"src:001:sap:db","sourceLevel2":"assets"} */
